...
class EDGARScraper:
    def __init__(
        self, email: str, output_dir: str = "def14a_filings", max_retries: int = 3
    ):
        """
    ...
    def get_filing_links(
        self, cik: str, filing_type: str = "DEF 14A", limit: int = 5
    ) -> List[Dict]:
    ...
    def _update_filing_status(
        self, cik: str, filing: Dict, status: str, filepath: str = None
    ):
